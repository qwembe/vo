...
def process_vo(p0, p1, p2):
    ...
    E1 = cv2.findEssentialMat(p0, p1)[0].T
    E2 = cv2.findEssentialMat(p1, p2)[0].T
    ...
    # four_solution_A = cv2.recoverPose(E1,p0,p1)
    # four_solution_B = cv2.recoverPose(E2,p1,p2)

    tr, Rt1, T1, A = cv2.recoverPose(E1, p0, p1)
    tr, Rt2, T2, B = cv2.recoverPose(E2, p1, p2)

    # print(four_solution_A[4])
